...
def Vgg16CBAM(in_image=(height, width, 1)):
   ...
   # conv2 = attach_attention_module(conv2, attention_module='cbam_block')
    ...
    conv5 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv5_1')(pool4)
    conv5 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv5_2')(conv5)
    conv5 = BatchNormalization()(conv5)
  

    up6 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv6_1')(conv5)
    up6 = UpSampling2D(size = (2,2),name = 'up_1')(up6)
   # merge6 = concatenate([conv4,up6], axis = 3)
    conv6 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv6_2')(up6)
    conv6 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal', name ='conv6_3')(conv6)
    conv6 = BatchNormalization()(conv6)

    up7 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name = 'conv7_1')(conv6)
    up7 = UpSampling2D(size = (2,2),name = 'up2')(up7)
    #merge7 = concatenate([conv3,up7], axis = 3)
    conv7 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name = 'conv7_2')(up7)
    conv7 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name = 'conv7_3')(conv7)
    conv7 = BatchNormalization()(conv7)

    up8 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal', name = 'conv8_1')(conv7)
    up8 = UpSampling2D(size = (2,2),name ='up3')(up8)
   # merge8 = concatenate([conv2,up8], axis = 3)
    conv8 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name = 'conv8_2')(up8)
    conv8 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name = 'conv8_3')(conv8)
    conv8 = BatchNormalization()(conv8)

    up9 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name = 'conv9_1')(conv8)
    up9 = UpSampling2D(size = (2,2),name = 'up4')(up9)
    #merge9 = concatenate([conv1,up9], axis = 3)
    conv9 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal', name = 'conv9_2')(up9)
    conv9 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name = 'conv9_3')(conv9)
    conv9 = BatchNormalization()(conv9)
    
    up10 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name = 'conv10_1')(conv9)
    up10 = UpSampling2D(size = (2,2),name = 'up5')(up10)
    #merge10 = concatenate([conv0,up10], axis = 3)
    conv10 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal', name = 'conv10_2')(up10)
    conv10 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name = 'conv10_3')(conv10)
    conv10 = BatchNormalization()(conv10)
    
    conv10 = Conv2D(1, 1, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal', name = 'conv10_4')(conv10)
