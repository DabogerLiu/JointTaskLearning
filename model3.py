...
def unet(in_image=(height, width, 1)):
    ...
    imgpre = Conv2D(6, 6, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv0_1')(c12)
    ...
    conv1 = Conv2D(6, 6, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv1_0')(pool0)
    conv1 = Dilation2D(6, (6,6),padding="same",strides=(1,1))(conv1)
    conv1 = Erosion2D(6, (6,6),padding="same",strides=(1,1))(conv1)
    conv1 = Conv2D(64, 5, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv1_1')(conv1)
    ...
    conv2 = Conv2D(6, 6, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv2_0')(pool1)
    conv2 = Dilation2D(6, (6,6),padding="same",strides=(1,1))(conv2)
    conv2 = Erosion2D(6, (6,6),padding="same",strides=(1,1))(conv2)
    conv2 = Conv2D(128, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv2_1' )(conv2)
    ...
    conv3 = Conv2D(6, 6, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv3_0')(pool2)
    conv3 = Dilation2D(6, (6,6),padding="same",strides=(1,1))(conv3)
    conv3 = Erosion2D(6, (6,6),padding="same",strides=(1,1))(conv3)
    conv3 = Conv2D(256, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv3_1')(conv3)
    ...
    conv4 = Conv2D(6, 6, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name='conv2_0')(pool3)
    conv4 = Dilation2D(6, (6,6),padding="same",strides=(1,1))(conv4)
    conv4 = Erosion2D(6, (6,6),padding="same",strides=(1,1))(conv4)
    conv4 = Conv2D(512, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal', name='conv4_1')(conv4)
...
def plot_img():
    ...
    n_test_samples = 500
    with CustomObjectScope({'Dilation2D': Dilation2D, 'Erosion2D':Erosion2D}):
